    ...
    def get(self, request, *args, **kwargs):
        ...
        if len(queryset) > 0:
            ...
            for author in queryset:
                ...
                try:
                    la_audio = audios.order_by("-created")[
                        0
                    ]  # TODO quizas cambie a date y alguna logica de favoritos
                ...
                try:
                    ml_audio = audios.filter(
                        author__type=Author.AUTH_PODCASTS
                    ).order_by("-listen_count")[0]
